...
import com.jofrantoba.httpfcm.HttpFcmConection;
import com.jofrantoba.httpfcm.NotificationMessage;
import com.jofrantoba.xmppfcm.XmppFcmNotification;
	...
	public static Boolean queueNotificationChatColonia(String codeTablonColonia){
		...
		try {					
			...
			while(iterador.hasNext()){
				...
				com.jofrantoba.xmppfcm.NotificationMessage not=new com.jofrantoba.xmppfcm.NotificationMessage();				
		    	...
		    	com.jofrantoba.xmppfcm.AndroidNotificationPayLoad payLoad=new com.jofrantoba.xmppfcm.AndroidNotificationPayLoad();
		    	payLoad.setTitle("Indiant");
		    	payLoad.setBody(bean.getMensaje());
		    	payLoad.setColor("#ffffff");
		    	payLoad.setSound("default");
		    	com.jofrantoba.xmppfcm.DataPayLoad dataPayLoad=new com.jofrantoba.xmppfcm.DataPayLoad();
